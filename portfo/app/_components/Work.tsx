        ...
        return(
               ...
               < Section className="flex  items-baselines ">
                <div className="flex flex-col w-full ">
                    <h1 className="sm:text-8xl max-md:text-6xl text-white w-full font-bold"> <BriefcaseIcon className="sm:h-32 sm:w-32 max-md:h-16 sm:w-16 text-green-500" ></BriefcaseIcon>My work</h1><br/>
                ...
                <h1 className="text-7xl font-bold  max-md:mt-6 text-green-500 ">
                    Dashboard
                </h1>
