        ...
        return(
               ...
               < Section className="flex  items-baselines ">
                <div className="flex flex-col w-full max-md:mt-20 ">
                    <h1 className="sm:text-8xl max-md:text-6xl text-white w-full font-bold max-md:ml-4"> <CheckBadgeIcon className="sm:h-32 sm:w-32 max-md:h-16 sm:w-16 text-green-500 " ></CheckBadgeIcon>Mes compétances</h1><br/>
                ...
                <h1 className="text-5xl font-bold  max-md:ml-4  max-md:mt-6 text-green-500 ">
                    Data analytics skills
                </h1>
                <p className="text-primary max-md:ml-4 mt-2">
